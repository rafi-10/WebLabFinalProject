        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form action="updateAction.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4">
              Update Product Name:
              <input type="text" class="form-control form-control-lg" name="productname" value="<?php echo $data['product_name']?>" Required>
            </div>

            <!-- Product price input -->
            <div class="form-outline mb-4">
              Update Product Price:
              <input type="number" class="form-control form-control-lg" name="price" required value="<?php echo $data['price']?>">
